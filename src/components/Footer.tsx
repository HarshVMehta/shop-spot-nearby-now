        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/category/home-kitchen" className="hover:underline">Home & Kitchen</Link></li>
              <li><Link to="/category/furniture" className="hover:underline">Furniture</Link></li>
